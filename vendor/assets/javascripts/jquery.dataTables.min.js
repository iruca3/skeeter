...
-1?c.replace("_INPUT_",'<input type="text" placeholder="絞り込み検索(2文字以上)" />'):c===""?'<input type="text" placeholder="絞り込み検索(2文字以上)" />':c+' <input type="text" placeholder="絞り込み検索(2文字以上)" />';var d=s.createElement("div");d.className=a.oClasses.sFilter;d.innerHTML="<label>"+c+"</label>";if(!a.aanFeatures.f)d.id=a.sTableId+"_filter";c=i('input[type="text"]',d);d._DT_Input=c[0];c.val(b.sSearch.replace('"',"&quot;"));c.bind("keyup.DT",function(){for(var e=a.aanFeatures.f,f=this.value===""?"":this.value,g=0,j=e.length;g<j;g++)e[g]!=i(this).parents("div.dataTables_filter")[0]&&i(e[g]._DT_Input).val(f);
...
h.fnCookieCallback)},fnStateSaveParams:null,iCookieDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iScrollLoadGap:100,iTabIndex:0,oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"最初",sLast:"最後",sNext:"次へ",sPrevious:"前へ"},sEmptyTable:"データがありません。",sInfo:"_START_ ～ _END_ を表示中 (合計: _TOTAL_件)",sInfoEmpty:"0 ～ 0 を表示中 (合計: 0件)",sInfoFiltered:"(全体: _MAX_件)",
sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"読込中...",sProcessing:"処理中...",sSearch:"<i class=\"icon-search\" class=\"vertical-align:middle;\"></i> 検索:",sUrl:"",sZeroRecords:"該当する項目は見つかりませんでした。"},oSearch:i.extend({},l.models.oSearch),sAjaxDataProp:"aaData",sAjaxSource:null,sCookiePrefix:"SpryMedia_DataTables_",sDom:"lfrtip",sPaginationType:"two_button",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET"};l.defaults.columns={aDataSort:null,asSorting:["asc","desc"],bSearchable:true,bSortable:true,
